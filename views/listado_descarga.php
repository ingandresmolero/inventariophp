        ...
        <div class="row b-3">
            <div class="col-md">
                <form action="" method="post">
                    ...
                    <a href="listado_descarga.php" class="btn-invert-1">Mostrar Todos</a>
                </form>
            </div>
        </div>
        <div class="table-responsive-sm">
            <table class="table table-style">
                ...
                <tbody>
                    ...
                    <?php
                    if (!$_GET) {
                        header('Location:listado_descarga.php?pagina=1');
                    }
                    ...
                    ?>
                        ...
                        <?php foreach ($resultado_stock as $stock) :
                            ...
                            <tr>
                                ...
                                <td class="action"><a class="table-btn" href="operacion/out_stock.php?stockid=<?php echo $codigo ?>">Retirar </a></td>
