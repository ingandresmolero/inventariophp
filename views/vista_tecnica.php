...
<body>
    ...
    <section class="container">
        <h1 class="page-heading">Vista Tecnica</h1>
        <!-- Button trigger modal -->

        <div class="col-auto ">
            <a href="./operacion/add_stock.php" class="btn-style-1">Crear Item</a>
        </div>
        <div class="row b-3">
            <div class="col-md">
                <form action="" method="post">
                    ...
                    <a href="vista_tecnica.php" class="btn-invert-1">Mostrar Todos</a>
                </form>
            </div>
        </div>
        <div class="table-responsive-sm">
            <table class="table table-style">
                ...
                <tbody>
                    ...
                    <?php
                    if (!$_GET) {
                        header('Location:vista_tecnica.php?pagina=1');
                    }
