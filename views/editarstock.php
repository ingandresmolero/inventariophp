                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-lg-3 ">
                            ...
                            <input type="tex" class="form-control" name="codigo" id="" placeholder="<?php echo $stock['codigo']?>" disabled>

                        </div>

                        <div class="col-lg-3">
                            <label for="" class="form-label">Nombre:</label>
                            <input type="tex" class="form-control" name="nombre" id="" placeholder="<?php echo $stock['nombre']?>" disabled>
                        </div>

                        <div class="col-lg-3">
                            <label for="" class="form-label">Descripcion:</label>
                            <input type="tex" class="form-control" name="descripcion" id="" placeholder="<?php echo $stock['descripcion']?>..." disabled>
                        </div>

                        <div class="col-3">
                            <label for="" class="form-label">Existencia:</label>
                            <input type="number" class="form-control" name="existencia" id="" placeholder="<?php echo $stock['existencia']?>...">
                        </div>
                        <div class="col-sm-3">
                            <label for="" class="form-label">Costo:</label>
                            <input type="number" class="form-control" name="costo" id="" placeholder="<?php echo $stock['costo']?>...">
                        </div>

                        <div class="row ">
                            <div class="col-sm-3">
                                <label for="" class="form-label">Precio 1:</label>
                                <input type="number" class="form-control" name="precio_1" id="" placeholder="<?php echo $stock['precio_1']?>...">
                            </div>
                            <div class="col-sm-3">
                                <label for="" class="form-label">Precio 2:</label>
                                <input type="number" class="form-control" name="precio_2" id="" placeholder="<?php echo $stock['precio_2']?>..."> 
                            </div>
                            <div class="col-sm-3">
                                <label for="" class="form-label">Precio 3:</label>
                                <input type="number" class="form-control" name="precio_3" id="" placeholder="<?php echo $stock['precio_3']?>...">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-3">
